...
// Obtener las solicitudes con estado "aceptada" (estado_id = 4)
$solicitudes = $solicitud_model->obtenerSolicitudesPorEstado(4);
?>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php } else { ?>
                                        <tr>
                                            <td colspan="6">No hay solicitudes aceptadas.</td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
