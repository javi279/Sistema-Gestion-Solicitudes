    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="../empleado/solicitudes.php" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="../empleado/solicitud_crear.php" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="../empleado/solicitudes_aceptadas.php" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="../empleado/solicitudes_enproceso.php" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="../empleado/solicitudes_pendientes.php" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="../empleado/solicitudes_finalizadas.php" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="../empleado/solicitudes_rechazadas.php" class="nav-link">
